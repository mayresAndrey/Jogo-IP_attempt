...
//criados
#include "src/combate.h"
#include "src/defines.h"
#include "src/explorando.h"
#include "src/load.h"
#include "src/personagens.h"
#include "src/salas.h"
...
int main(){
    ...
    InitWindow(screenWidth, screenHeight, "Missão IBAMA: Contra-Ataque a Thalya");
    InitAudioDevice();
    SetMasterVolume(5.0);
...
//-------------------------------------------------------------------LOADS-------------------------------------------------------------------
    //problema em passar os ponteiros direito 
    loadPrincipal(  &capivara, &boss, &animal, 
                    &sala, &arena, 
